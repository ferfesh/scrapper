...
const scraper = async (url, selector) => {
    ...
    try {
        ...
        switch (selector) {
            case 'Amazon':
                price = await page.$eval('.a-price-whole', (element) => { var _a; return (_a = element === null || element === void 0 ? void 0 : element.textContent) === null || _a === void 0 ? void 0 : _a.trim(); });
                break;
            case 'Noon':
                price = await page.$eval('.priceNow', (element) => { var _a; return (_a = element === null || element === void 0 ? void 0 : element.textContent) === null || _a === void 0 ? void 0 : _a.trim(); });
                break;
        }
        console.log(price);
